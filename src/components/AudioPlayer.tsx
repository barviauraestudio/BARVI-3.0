  ...
  return (
    <>
      ...
      <style>{`
        ...
        @keyframes btnPulse {
          0%,100% { box-shadow: 0 0 0 0 rgba(167,135,121,0); border-color: rgba(167,135,121,0.28); }
          50%      { box-shadow: 0 0 0 8px rgba(167,135,121,0.1); border-color: rgba(167,135,121,0.6); }
        }
        @keyframes fadeUp {
        ...
        .b3 { height: 10px; }
        .b4 { height: 6px; }
        #audioBtn.playing .b1 { animation: barPulse 0.9s ease-in-out 0.0s infinite alternate; background: #a78779; }
        #audioBtn.playing .b2 { animation: barPulse 0.9s ease-in-out 0.2s infinite alternate; background: #a78779; }
        #audioBtn.playing .b3 { animation: barPulse 0.9s ease-in-out 0.1s infinite alternate; background: #a78779; }
        #audioBtn.playing .b4 { animation: barPulse 0.9s ease-in-out 0.3s infinite alternate; background: #a78779; }
        ...
        #audioBtn.playing .audio-label { color: #a78779; }
        #audioBtn:hover .audio-label   { color: #c9b5ac; }
