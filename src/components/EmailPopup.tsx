        ...
        >
          <div style={{ width: '100%', padding: 'clamp(36px, 6vw, 56px)', position: 'relative', boxSizing: 'border-box' }}>
            ...
            <div style={{
              ...
              background: 'radial-gradient(ellipse 70% 50% at 50% 0%, rgba(167,135,121,0.22) 0%, transparent 70%)',
            }} />

            {/* Tint taupe */}
            <div style={{
              position: 'absolute', inset: 0, pointerEvents: 'none',
              backgroundImage: 'linear-gradient(135deg, rgba(255,240,210,0.07) 0%, rgba(167,135,121,0.05) 30%, rgba(125,93,80,0.03) 55%, transparent 75%)',
            }} />
            ...
            <button
              ...
              onMouseOver={e => (e.currentTarget.style.color = '#a78779')}
              ...
              {status === 'success' ? (
                <div style={{ textAlign: 'center' }}>
                  <div style={{
                    ...
                    border: '1px solid rgba(167,135,121,0.4)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    margin: '0 auto 24px',
                    background: 'rgba(167,135,121,0.08)',
                  }}>
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#a78779" strokeWidth="1.5">
                ...
                <div>
                  <p style={{ fontSize: 10, letterSpacing: '0.5em', textTransform: 'uppercase', color: '#7d5d50', marginBottom: 20 }}>
                    · Barví Aura Estúdio ·
                  </p>
                  <h2 style={{
                    fontFamily: "'Cormorant Garamond', Georgia, serif",
                    ...
                    Fique na <em style={{ color: '#a78779', fontStyle: 'italic' }}>frequência.</em>
                  </h2>
                  ...
                  <div style={{ marginBottom: 14 }}>
                    <input
                      ...
                      style={{
                        ...
                        border: `1px solid ${errorMsg ? 'rgba(192,48,42,0.6)' : 'rgba(167,135,121,0.2)'}`,
                        borderRadius: 8,
                        padding: '14px 18px',
                      ...
                      onFocus={e => e.currentTarget.style.borderColor = 'rgba(167,135,121,0.5)'}
                      onBlur={e => e.currentTarget.style.borderColor = errorMsg ? 'rgba(192,48,42,0.6)' : 'rgba(167,135,121,0.2)'}
                    />
                  </div>
                  {errorMsg && (
                  ...
                  <button
                    ...
                    style={{
                      width: '100%',
                      background: status === 'loading' ? 'rgba(167,135,121,0.6)' : '#a78779',
                    ...
                    onMouseOver={e => { if (status !== 'loading') e.currentTarget.style.background = '#c9b5ac' }}
                    onMouseOut={e => { if (status !== 'loading') e.currentTarget.style.background = '#a78779' }}
                  >
